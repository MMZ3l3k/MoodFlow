...
export const VARIANTS: Record<AuthVariant, VariantTheme> = {
  ...
  admin: {
    ...
    features: [
      { icon: '📊', title: 'Zagregowane raporty HR', desc: 'Trendy działowe i firmowe z zachowaniem prywatności.' },
      { icon: '🛡️', title: 'Anonimizacja u źródła', desc: 'Brak indywidualnych wyników w panelu HR.' },
      { icon: '⚡', title: 'Alerty i punktowane ryzyka', desc: 'Reaguj wcześniej, zanim sytuacja się pogorszy.' },
    ],
    loginRoute: '/login',
  ...
  super: {
    ...
    features: [
      { icon: '🏢', title: 'Wielodostępność', desc: 'Zarządzanie wszystkimi organizacjami i ich administratorami.' },
      { icon: '🔐', title: 'Najwyższy poziom uprawnień', desc: 'Pełna kontrola nad rolami, dostępem i konfiguracją.' },
      { icon: '📡', title: 'Status platformy w czasie rzeczywistym', desc: 'Monitorowanie kondycji systemu i wskaźników kluczowych.' },
    ],
