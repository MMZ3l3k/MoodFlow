        ...
        <div className="auth-form-wrap">
          ...
          >
            <div className="auth-card-header">
              ...
              >
                <svg width="10" height="10" viewBox="0 0 20 20" fill="currentColor" style={{ marginRight: 6 }}>
                  <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd"/>
                </svg>
                {t.badge} · DOSTĘP ZASTRZEŻONY
              </span>
              <h1 className="auth-card-title" style={{ color: t.text }}>
                Panel właściciela
              </h1>
              <p className="auth-card-subtitle" style={{ color: t.textMuted }}>
                Tylko osoby z rolą SUPER_ADMIN mogą zalogować się do tego panelu.
              </p>
            </div>
